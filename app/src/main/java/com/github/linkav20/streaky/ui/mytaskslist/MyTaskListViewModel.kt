...
class MyTaskListViewModel @Inject constructor(
    ...
    private fun getFakeData() = listOf(
        MyTaskUIModel(0, "Lol", false, false),
        MyTaskUIModel(1, "Kekekkeke", false, false),
        MyTaskUIModel(2, "--", false, false),
        MyTaskUIModel(3, "<Maedkjvnlm;lv';efllickudjyxhtcfgvbjknjlm;lkj>", false, false),
        MyTaskUIModel(4, "<Maedkjvnlm;lv';efllickudjyxhtcfgvbjknjlm;lkj>", false, false),
        MyTaskUIModel(5, "--", false, false)
    )
